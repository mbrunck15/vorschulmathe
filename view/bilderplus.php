...
<div style="display: flex">
    ...
    <div><img src="<?php echo $aArr['bild2'];?>" id="bild"></div>
    <div id="loesung" class="ziel botton" style="margin-left: 120px" ondrop="drop(event)" ondragover="allowDrop(event)" data-loesung="<?php echo $aArr['loesung1'];?>" data-id="<?php echo $aArr['id'] ?>"></div>
</div>
<div id="senk">
...
<div class="auswahlzahl"><img id="drag2" src="<?php echo $aArr['loesungsbild2'];?>" data-wert="<?php echo $l2 ?>" draggable="true" ondragstart="drag(event)" width="60px" height="60px" data></div>
