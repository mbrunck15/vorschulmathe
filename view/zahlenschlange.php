...
<div id="s">
    <div id="schlange">
        ...
        <div id="loesung" class="schlangezahl top2px" ondrop="drop(event)" ondragover="allowDrop(event)" data-loesung="<?php echo $aArr['loesung1']; ?>" data-id="<?php echo $aArr['id'] ?>"></div>
        <div class="schlangezahl"><img src="<?php echo $aArr['wert3']; ?>" class="bild1"></div>
        <div id="loesung1" class="schlangezahl bottem2px" ondrop="drop1(event)" ondragover="allowDrop(event)" data-loesung="<?php echo $aArr['loesung2']; ?>" ></div>
...
<script>
    ...
    console.log(document.getElementById('loesung'));
